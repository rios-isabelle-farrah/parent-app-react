...
import { deleteMeetingByID, getAllMeetingsFN } from "../../util/networkRequest";
    ...
    <>
      ...
      <div className="meeting-details">
        <div className="meeting-box">
          <p className="meeting-details-p">File: {files[id]?.child_name}</p>
          <p className="meeting-details-p">
            Date:
            {meet?.date}
          </p>
          <p className="meeting-details-p">Meeting Type: {meet?.category}</p>
          <br></br>
          <p className="meeting-details-p">Details: {meet?.details}</p>
        </div>
        ...
        <div className="button-frames-show">
          ...
          <div className="frames-delete">
            <button
              className="button-frames-delete"
